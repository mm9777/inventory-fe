...
const ViewBill = React.lazy(()=> import('./views/Bill/ViewBill'))
...
const routes = [
  ...
  {path: '/Product', name:'Product', component:ViewProduct, exact:true},
  {path:'/Product/ViewProduct', name:'ViewProduct', element:ViewProduct,exact:true},
  {path: '/Bill', name:'Bill',component:ViewBill, exact:true},
  {path:'/Bill/ViewBill', name:'Billing',element:ViewBill,exact:true}
